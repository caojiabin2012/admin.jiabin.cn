...
linuxDash.service('serverAddress', ['$q', function ($q) {
    ...
    this.configure = function () {
        return  $q.when(localStorage.setItem('serverFile',''));
    }
...
linuxDash.service('server', ['$http', function ($http) {
    ...
    this.get = function (moduleName, callback) {
        ...
        var moduleAddress = serverAddress + '?a=Main/Tools&m=linuxDashServer' +'&module=' + moduleName;
        // var moduleAddress = '172.16.75.129:10000?a=Main/Tools&m=linuxDashServer' +'&module=' + moduleName;
