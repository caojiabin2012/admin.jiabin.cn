...
?>
    ...
    <div class="container">
        ...
        <?php $active = 'portcode'; include(__DIR__.'/tablist.php');?>
        ...
        <div class="alert alert-success alert-dismissible" role="alert">
            ...
            HTTP,TCP,UDP常见端口查询：下面列举了包括在红帽企业 Linux 中的服务、守护进程、和程序所使用的最常见的通信端口<br />
            <code>窍门：Ctrl+F 快速查找 Http端口号（为了方便查看,下面的6个标题都是可以收缩的哦）</code>
        </div>
        ...
        <div class="accordion">
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <a class="list-group-item list-group-item-warning" data-toggle="collapse" href="#demo2">
                        <span class="glyphicon" aria-hidden="true">No2.</span> UNIX 特有的端口（以下端口是 UNIX 特有的，涉及了从电子邮件到验证不等的服务。在方括号内的名称（如
                        [service]）是服务的守护进程名称或它的常用别名）</a>
                </div>
                <div id="demo2" class="in collapse">
                    <table width="100%" cellspacing="0" cellpadding="0" class="table  table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                通过传输控制协议（TCP）的 Appletalk 文件编制协议（AFP）
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <a class="list-group-item list-group-item-success" data-toggle="collapse" href="#demo3">
                        <span class="glyphicon" aria-hidden="true">No3.</span> 注册的端口（列举了由网络和软件社区向 IANA 提交的要在端口号码列表中正式注册的端口）</a>
                </div>
                <div id="demo3" class="in collapse">
                    <table width="100%" cellspacing="0" cellpadding="0" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                用于 Coda 文件系统（codacon 端口）的 Venus 缓存管理器
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                用于 Coda 文件系统（callback/wbc interface 界面）的 Venus 缓存管理器
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                Dell Netmon；用于 IPv6 的 OSPF 守护进程（ospf6d）
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                互联网缓存协议版本2（v2）；被 Squid 代理缓存服务器使用
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                Veritas NetBackup 数据库管理器（bpdbm）
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="3">
                                ...
                                <br>
                                /etc/services 文件中的注释：该端口被注册为 wnn6，但是还在 FreeWnn 软件包中使用了未注册的“wnn4”。<br>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <a class="list-group-item list-group-item-success" data-toggle="collapse" href="#demo4">
                        <span class="glyphicon" aria-hidden="true">No4.</span> 数据报传递协议端口（显示了一个和数据报传递协议（DDP）有关的端口列表。DDP
                        在 AppleTalk 网络上被使用）</a>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <a class="list-group-item list-group-item-success" data-toggle="collapse" href="#demo5">
                        <span class="glyphicon" aria-hidden="true">No5.</span> Kerberos（工程Athena/MIT）端口（和
                        Kerberos网络验证协议相关的端口列表在标记的地方,v5代表Kerberos版本5协议,这些端口没有在IANA注册）</a>
                </div>
            ...
            <div class="accordion-group">
                <div class="accordion-heading">
                    <a class="list-group-item list-group-item-success" data-toggle="collapse" href="#demo6">
                        <span class="glyphicon" aria-hidden="true">No6.</span>未注册的端口（这些端口可能被安装在你红帽企业 Linux系统上的服务或协议使用,或者它们是在红帽企业Linux和运行其它操作系统的机器通信所必需的端口）</a>
                </div>
                <div id="demo6" class="in collapse">
                    <table width="100%" cellspacing="0" cellpadding="0" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                Hewlett-Packard (HP) JetDirect 网络打印服务
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                Binkley TCP/IP Fidonet 邮寄程序守护进程
                            </td>
                        </tr>
                        <tr>
                            <td>
